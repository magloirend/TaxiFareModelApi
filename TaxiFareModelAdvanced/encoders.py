...
from TaxiFareModelAdvanced.data import df_optimized, get_data, clean_df, DIST_ARGS
from TaxiFareModelAdvanced.utils import haversine_vectorized, minkowski_distance
import pygeohash as gh
import TaxiFareModelAdvanced

folder_source, _ = split(TaxiFareModelAdvanced.__file__)
